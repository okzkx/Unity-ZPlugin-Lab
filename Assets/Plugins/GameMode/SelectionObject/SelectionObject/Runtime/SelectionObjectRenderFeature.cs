...
internal class SelectionObjectRenderPass : ScriptableRenderPass {
    ...
    private void RecreateInstanceIDTexture() {
    ...
    public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData) {
        ...
        if (_renderTexture.width != Screen.width || _renderTexture.width != Screen.height) {
            RecreateInstanceIDTexture();
        }

        var cmd = CommandBufferPool.Get("SelectionObject Render Pass");
        cmd.SetRenderTarget(_renderTexture, depthAttachmentHandle);
