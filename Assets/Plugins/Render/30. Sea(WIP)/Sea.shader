    ...
    SubShader {
        ...
        Pass {
            ...
            half4 WaterFragment(RiverVaryings IN) : SV_Target
            {
                ...
                half2 screenUV = IN.clipPos.xy / _ScreenParams.xy;
                ...
                half3 reflection = 1;
                // half3 reflection =  SAMPLE_TEXTURECUBE_ARRAY_LOD_ABSTRACT(_EnvCubemapTextures,
                //     s_trilinear_clamp_sampler,reflectVector, _EnvSliceSize * 1, 0).rgb;
                ...
                SimpleLight mainLight = GetSimpleLight();

                // 高光项 : Bling-phone
                half3 halfDir = SafeNormalize(mainLight.directionWS + viewDir);
